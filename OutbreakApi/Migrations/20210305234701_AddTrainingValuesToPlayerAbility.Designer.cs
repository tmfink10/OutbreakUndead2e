...
namespace OutbreakApi.Migrations
{
    ...
    [Migration("20210305234701_AddTrainingValuesToPlayerAbility")]
    partial class AddTrainingValuesToPlayerAbility
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OutbreakModels.Models.BaseAbility", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OutbreakModels.Models.BaseAttribute", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OutbreakModels.Models.BaseSkill", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OutbreakModels.Models.BaseTrainingValue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OutbreakModels.Models.PlayerAbility", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OutbreakModels.Models.PlayerAttribute", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OutbreakModels.Models.PlayerCharacter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OutbreakModels.Models.PlayerSkill", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("PlayerCharacterId1");

                    b.ToTable("PlayerSkills");
                });

            modelBuilder.Entity("OutbreakModels.Models.PlayerTrainingValue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OutbreakModels.Models.BaseAttribute", b =>
                {
                    b.HasOne("OutbreakModels.Models.BaseAbility", null)
            ...
            modelBuilder.Entity("OutbreakModels.Models.BaseSkill", b =>
                {
                    ...
                    b.HasOne("OutbreakModels.Models.BaseAttribute", "PrimaryAttribute")
                        .WithMany()
                        .HasForeignKey("PrimaryAttributeId");

                    b.HasOne("OutbreakModels.Models.BaseAttribute", "SecondaryAttribute")
                        .WithMany()
            ...
            modelBuilder.Entity("OutbreakModels.Models.PlayerAbility", b =>
                {
                    b.HasOne("OutbreakModels.Models.BaseAbility", "BaseAbility")
                        .WithMany()
                        .HasForeignKey("BaseAbilityId")
            ...
            modelBuilder.Entity("OutbreakModels.Models.PlayerAttribute", b =>
                {
                    b.HasOne("OutbreakModels.Models.BaseAttribute", "BaseAttribute")
                        .WithMany()
            ...
            modelBuilder.Entity("OutbreakModels.Models.PlayerSkill", b =>
                {
                    b.HasOne("OutbreakModels.Models.BaseSkill", "BaseSkill")
                        .WithMany()
                        .HasForeignKey("BaseSkillId");

                    b.HasOne("OutbreakModels.Models.PlayerAbility", null)
                    ...
                    b.HasOne("OutbreakModels.Models.PlayerCharacter", null)
                        ...
                        .HasForeignKey("PlayerCharacterId1");
            ...
            modelBuilder.Entity("OutbreakModels.Models.PlayerTrainingValue", b =>
                {
                    b.HasOne("OutbreakModels.Models.BaseTrainingValue", "BaseTrainingValue")
                        .WithMany()
                        .HasForeignKey("BaseTrainingValueId");

                    b.HasOne("OutbreakModels.Models.PlayerAbility", null)
                        .WithMany("ImprovesTrainingValues")
                        .HasForeignKey("PlayerAbilityId");
            ...
            modelBuilder.Entity("OutbreakModels.Models.PlayerAbility", b =>
                {
                    b.Navigation("ImprovesTrainingValues");
            ...
            modelBuilder.Entity("OutbreakModels.Models.PlayerCharacter", b =>
                {
                    ...
                    b.Navigation("SpecializedPlayerSkills");
